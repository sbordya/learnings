...
def create_aggregated_events_ip_host_sink_postgres(t_env):
    table_name = 'processed_events_aggregated_ip_host'
    sink_ddl = f"""
...
def log_aggregation():
    ...
    try:
        ...
        aggregated_events_ip_host_table = create_aggregated_events_ip_host_sink_postgres(t_env)
        ...
        t_env.from_path(source_table)\
            ...
            .execute_insert(aggregated_events_ip_host_table)
